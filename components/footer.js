      ...
      <footer className="flex-1 flex flex-row items-start justify-between text-left text-5xl text-gray-black font-body-regular-400 md:flex-col md:gap-[50px] sm:flex-col sm:gap-[50px]">
        ...
        <div className="w-[173px] flex flex-col items-start justify-start gap-[32px]">
          ...
          <div className="flex flex-col items-start justify-start gap-[16px] text-base text-gray-500">
            <a href="" className="leading-[24px]">Home</a>
            <a href="" className="leading-[24px]">Become a Host</a>
            <a href="" className="leading-[24px]">Pricing</a>
            <a href="" className="leading-[24px]">Blog</a>
            <a href="" className="leading-[24px]">Contact</a>
          </div>
        </div>
        <div className="w-[173px] flex flex-col items-start justify-start gap-[32px]">
          <div className="leading-[32px] font-semibold">Company</div>
          <div className="flex flex-col items-start justify-start gap-[16px] text-base text-gray-500">
            <a href="" className="leading-[24px]">About Us</a>
            <a href="" className="leading-[24px]">Press</a>
            <a href="" className="leading-[24px]">Contact</a>
            <a href="" className="leading-[24px]">Careers</a>
            <a href="" className="leading-[24px]">Blog</a>
          </div>
        </div>
        <div className="w-[203px] flex flex-col items-start justify-start gap-[32px]">
          ...
          <div className="flex flex-col items-start justify-start gap-[16px] text-base text-gray-500">
            <a href="" className="leading-[24px]">Terms of servies</a>
            <a href="" className="leading-[24px]">Privacy Policy</a>
            <a href="" className="leading-[24px]">Security</a>
          </div>
        </div>
      </footer>
    </div>
